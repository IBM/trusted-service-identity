...
func main() {
	...
	writeKey("leaf1-key.pem", leafKey)
	writeCerts("leaf1-crt-bundle.pem", leafCert, intermediateCert)
	writeCerts("leaf1.pem", leafCert)
	...
	writeKey("leaf2-key.pem", leafKey)
	writeCerts("leaf2-crt-bundle.pem", leafCert, intermediateCert)
	writeCerts("leaf2.pem", leafCert)
	...
	writeKey("leaf3-key.pem", leafKey)
	writeCerts("leaf3-crt-bundle.pem", leafCert, intermediateCert)
	writeCerts("leaf3.pem", leafCert)
}
