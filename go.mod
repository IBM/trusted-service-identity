module github.com/IBM/trusted-service-identity
...
require (
	...
	golang.org/x/tools v0.0.0-20200806183231-ee49e490f2e5 // indirect
	...
	k8s.io/kubernetes v0.0.0-20180920232533-824ebd5e02df
)
